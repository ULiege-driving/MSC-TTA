...
def segment(data_path, model_name, args):
    ...
    pseudo_gt_path = os.path.join(data_path, 'pseudos')
    ...
    for folder in img_tree:
        ...
        for img in tqdm(img_list):
            ...
            frame = cv2.imread(os.path.join(img_path, folder, img))
...
def build_model(model_name):
    if model_name == "pspnet":
        ...
        config = os.path.join('..', 'mmsegmentation', 'configs', 'setr',
