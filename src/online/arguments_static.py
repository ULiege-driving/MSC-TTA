...
parser.add_argument("--pretraining", help="Specify the weight initialization", default="scratch", choices=['scratch', 'general', 'specific'])
parser.add_argument("--pretraining_path", help="Path to pretraining weights folder", default=None)

parser.add_argument("--cell_type", help="Describe environment partition", type=str, choices=['common', 'spatial', 'standalone'], required=True)
...
parser.add_argument("--other_exp", choices=[None, "Houyon", "ArTHUS"], default=None)
