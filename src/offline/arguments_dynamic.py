...
parser.add_argument("--dynamic_weather", action='store_true', default=False)
...
#parser.add_argument("--pretraining", help="Specify the weight initialization", default="no_env", choices=['no_env', 'specific', 'spatial', 'weather', 'period', 'weatherperiod'])
parser.add_argument("--pretraining_path", help="Path to pretraining weights folder", default=None)

parser.add_argument("--cell_type", help="Describe environment partition", type=str, choices=['common', 'specific', 'spatial', 'weather', 'daylight', 'weatherdaylight'], required=True)
